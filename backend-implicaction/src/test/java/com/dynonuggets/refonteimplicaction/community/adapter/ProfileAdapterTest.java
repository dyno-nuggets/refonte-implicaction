...
import static com.dynonuggets.refonteimplicaction.community.utils.ProfileTestUtils.generateRandomProfile;
...
class ProfileAdapterTest {
    ...
    class ToDtoTest {
        ...
        void should_map_to_dto_when_toDto_and_model_is_not_null() {
            ...
            assertThat(profileDto.getFirstname()).isEqualTo(profile.getFirstname());
            assertThat(profileDto.getLastname()).isEqualTo(profile.getLastname());
            assertThat(profileDto.getBirthday()).isEqualTo(profile.getBirthday());
