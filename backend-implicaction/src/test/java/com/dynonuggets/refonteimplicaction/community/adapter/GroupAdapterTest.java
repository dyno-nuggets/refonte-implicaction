...
class GroupAdapterTest {
    ...
    void should_map_to_model() {
        ...
        final GroupDto expected = GroupDto.builder().id(123L)
        ...
        assertThat(actual)
                ...
                .ignoringFields("image", "posts", "user", "users")
                .isEqualTo(expected);
    ...
    void should_map_to_dto_with_count_when_model_has_posts() {
        ...
        final Group expectedModel = Group.builder()
                .id(123L)
                .description("blablabla")
                .name("blabla")
    ...
    void should_map_to_dto_with_image_url_when_model_has_image() {
        ...
        final String expectedUrl = "http://url/objectKey";
